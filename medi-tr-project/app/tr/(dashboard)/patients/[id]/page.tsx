                ...
                <div className="bg-white rounded-2xl border-2 border-gray-100 p-6 hover:shadow-lg transition-all">
                  ...
                  <div className="space-y-4">
                    {patient.emergencyContacts?.map((contact, index) => (
                      <div key={index} className="p-4 bg-gradient-to-br from-red-50 to-orange-50 rounded-xl border-2 border-red-100">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <p className="font-black text-gray-900">{contact.name}</p>
                            <p className="text-sm font-semibold text-gray-600">{contact.relationship}</p>
                          </div>
