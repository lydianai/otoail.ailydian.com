        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link href="/tr/demo" className="group px-8 py-4 bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-2xl font-black text-lg hover:shadow-2xl hover:shadow-red-500/50 transition-all flex items-center gap-3">
                Demo Talep Edin
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/tr/contact" className="group px-8 py-4 bg-white text-gray-900 rounded-2xl font-black text-lg border-2 border-gray-200 hover:border-red-500 transition-all flex items-center gap-3">
