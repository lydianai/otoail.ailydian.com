      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 font-medium max-w-3xl mx-auto">
            Seamless interoperability with major EHR systems, health information exchanges, and government health networks. Connect with Epic, Cerner, e-Nabız, and more.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-8 border-2 border-amber-200">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">Epic & Cerner</h3>
              <p className="text-gray-700 font-semibold mb-4">Bidirectional integration with Epic (EpicCare, MyChart) and Cerner Millennium for hospital systems.</p>
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2 text-sm font-semibold text-gray-700"><CheckCircle className="h-4 w-4 text-amber-600" />Cerner Millennium ADT/ORM</li>
