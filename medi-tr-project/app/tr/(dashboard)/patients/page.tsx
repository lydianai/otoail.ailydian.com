      ...
      {isNewPatientModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="sticky top-0 bg-gradient-to-r from-red-600 to-rose-600 text-white px-8 py-6 rounded-t-3xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                  <UserCheck className="h-7 w-7" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold">Yeni Hasta Kaydı</h2>
                  <p className="text-red-100 text-sm">Hasta bilgilerini eksiksiz doldurun</p>
                </div>
              </div>
              <button
