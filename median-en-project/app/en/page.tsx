        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a href="/en/patients" target="_blank" rel="noopener noreferrer" className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-2xl font-black text-lg hover:shadow-2xl hover:shadow-blue-500/50 transition-all flex items-center gap-3">
                Management Center
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="/en/dashboard" target="_blank" rel="noopener noreferrer" className="group px-8 py-4 bg-white text-gray-900 rounded-2xl font-black text-lg border-2 border-gray-200 hover:border-blue-500 transition-all flex items-center gap-3">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-400">
                  ...
                  <span className="font-semibold">+1 (888) 555-0123</span>
                </li>
                <li className="flex items-center gap-2 text-gray-400">
                  <Mail className="h-4 w-4" />
                  <span className="font-semibold">sales@lydianmedi.com</span>
                </li>
