    ...
    <DashboardLayout>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="relative p-3 hover:bg-gray-100 rounded-xl transition-all border-2 border-gray-200"
              >
              ...
              <button
                ...
                className="p-3 hover:bg-gray-100 rounded-xl transition-all border-2 border-gray-200"
              >
              ...
              <div className="flex items-center gap-3 pl-4 border-l-2 border-gray-200">
                ...
                <button
                  ...
                  className="p-3 hover:bg-blue-100 rounded-xl transition-all border-2 border-gray-200 hover:border-blue-300"
                >
      ...
      <main className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {aiInsights.filter(i => i.type === 'critical').length > 0 && (
          <div className="mb-8 bg-gradient-to-r from-red-50 to-orange-50 border-2 border-blue-300 rounded-2xl p-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          {/* Critical Patients */}
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-2xl p-6 text-white shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
              ...
              <div className="space-y-4">
                {bedCapacity.slice(0, 6).map(dept => {
                  const utilizationColor =
                    dept.utilizationRate > 90 ? 'bg-blue-500' :
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                          ...
                          <div className={cn(
                            ...
                            dept.utilizationRate > 90 ? 'bg-blue-100 text-blue-700 border border-blue-200' :
            ...
            <div className="p-6">
              <div className="space-y-3">
                {aiInsights.map(insight => {
                  const iconMap = {
                    critical: <AlertTriangle className="h-5 w-5 text-blue-500" />,
                  ...
                  const bgMap = {
                    critical: 'bg-blue-50 border-blue-200',
        ...
        <div className="mb-8 bg-white rounded-2xl border-2 border-blue-200 shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-red-50 to-orange-50 px-6 py-5 border-b-2 border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-1">
              ...
              <div className="px-3 py-1.5 bg-blue-600 text-white rounded-xl text-sm font-bold shadow-lg">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {criticalPatients.slice(0, 6).map(patient => (
                <div key={patient.id} className="p-5 rounded-2xl border-2 border-blue-200 bg-blue-50/50 hover:shadow-xl transition-all hover:border-blue-300">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="px-2 py-1 bg-blue-600 text-white rounded-lg text-xs font-bold">
                  ...
                  <div className="space-y-2.5 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`font-bold ${patient.vitalSigns.heartRate > 100 || patient.vitalSigns.heartRate < 60 ? 'text-blue-600' : 'text-green-600'}`}>
                        {patient.vitalSigns.heartRate} bpm
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 font-semibold">SpO2:</span>
                      <span className={`font-bold ${patient.vitalSigns.oxygenSaturation < 95 ? 'text-blue-600' : 'text-green-600'}`}>
                        {patient.vitalSigns.oxygenSaturation}%
                      </span>
                    </div>
                  </div>
                  <button className="w-full mt-4 px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-2 font-bold text-sm">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">Recent system alerts and updates</p>
                </div>
              </div>
              <button
                onClick={() => setShowNotifications(false)}
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-2xl border-2 border-red-200 bg-red-50">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-red-900 mb-1">Critical Patient Alert</h3>
                      <p className="text-sm text-red-700">Patient MRN-4523 vital signs deteriorating in ICU Bed 12</p>
                      <p className="text-xs text-red-600 mt-2">2 minutes ago</p>
                    </div>
                  </div>
                </div>

                <div className="p-5 rounded-2xl border-2 border-orange-200 bg-orange-50">
                  <div className="flex items-start gap-3">
                    <Bed className="h-6 w-6 text-orange-600 flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <h3 className="font-bold text-orange-900 mb-1">High Bed Occupancy</h3>
                      <p className="text-sm text-orange-700">Emergency Department at 95% capacity - consider surge protocol</p>
                      <p className="text-xs text-orange-600 mt-2">15 minutes ago</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl border-2 border-blue-200 bg-blue-50">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-blue-900 mb-1">AI Prediction</h3>
                      <p className="text-sm text-blue-700">Expected 12 admissions in next 6 hours based on historical patterns</p>
                      <p className="text-xs text-blue-600 mt-2">1 hour ago</p>
                    </div>
                  </div>
                </div>

                <div className="p-5 rounded-2xl border-2 border-green-200 bg-green-50">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <h3 className="font-bold text-green-900 mb-1">System Update Complete</h3>
                      <p className="text-sm text-green-700">Platform updated to version 2.5.1 - Enhanced security features</p>
      ...
      {showSettings && (
        ...
        >
          <div
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Settings className="h-7 w-7" />
                <div>
                  <h2 className="text-2xl font-bold">Settings</h2>
                  <p className="text-purple-100 text-sm">Configure your dashboard preferences</p>
                </div>
              </div>
              <button
                onClick={() => setShowSettings(false)}
            ...
            <div className="p-8 overflow-y-auto max-h-[60vh]">
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-2xl border-2 border-gray-200 hover:border-purple-300 transition-all">
                      <div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl border-2 border-gray-200 hover:border-purple-300 transition-all">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Update metrics every 5 seconds</p>
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-2xl border-2 border-gray-200 hover:border-purple-300 transition-all">
                      <div>
                        <p className="font-bold text-gray-900">Critical Alerts</p>
                        <p className="text-sm text-gray-600">Push notifications for critical events</p>
                      </div>
                      <button className="w-12 h-6 bg-purple-600 rounded-full relative">
                        <div className="w-5 h-5 bg-white rounded-full absolute top-0.5 right-0.5 shadow-md"></div>
                      </button>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl border-2 border-gray-200 hover:border-purple-300 transition-all">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Daily summary of key metrics</p>
                      </div>
                      <button className="w-12 h-6 bg-purple-600 rounded-full relative">
                        <div className="w-5 h-5 bg-white rounded-full absolute top-0.5 right-0.5 shadow-md"></div>
                      </button>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <button className="w-full p-4 rounded-2xl border-2 border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all text-left">
