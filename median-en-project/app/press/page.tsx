...
export default function PressPage() {
  const pressReleases = [
    ...
    {
      date: 'August 20, 2025',
      title: 'Median Partners with Epic Systems for Seamless EHR Integration',
      excerpt: 'New certified integration enables bi-directional data exchange with Epic EHR systems nationwide.',
