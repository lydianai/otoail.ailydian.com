...
// ============================================
// TÜRK OTO AI - Battery Optimizer Dashboard
// Akü optimizasyon ve tasarruf dashboard'u
// ============================================
...
export default function BatteryOptimizerPage() {
  ...
  const [batterHealth, setBatteryHealth] = useState<any>(null);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold">Akü Optimizasyonu</h1>
            </div>
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="relative mb-6">
                  <div className={`${getHealthBgColor(batterHealth.soh)} rounded-2xl p-8 text-center`}>
                    <p className="text-gray-600 text-sm mb-2">State of Health (SOH)</p>
                    <p className={`text-6xl font-bold ${getHealthColor(batterHealth.soh)}`}>
                      {batterHealth.soh.toFixed(1)}%
                    </p>
                    <p className="text-gray-600 mt-2">{batterHealth.status}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div className="bg-blue-50 rounded-xl p-4">
                    ...
                    <p className="text-xl font-bold text-blue-600">{batterHealth.soc}%</p>
                  </div>

                  <div className="bg-purple-50 rounded-xl p-4">
                    <Activity className="w-5 h-5 text-purple-600 mb-2" />
                    <p className="text-xs text-gray-600 mb-1">Döngü Sayısı</p>
                    <p className="text-xl font-bold text-purple-600">{batterHealth.cycleCount}</p>
                  </div>
                  ...
                  <div className="bg-yellow-50 rounded-xl p-4">
                    ...
                    <p className="text-xl font-bold text-yellow-600">
                      {batterHealth.batteryTemp?.toFixed(1)}°C
                    </p>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-xl p-4">
                    ...
                    <p className="text-xl font-bold text-green-600">
                      {batterHealth.voltage?.toFixed(1)}V
                    </p>
                  </div>
                </div>

                {/* Warnings */}
                {batterHealth.warnings && batterHealth.warnings.length > 0 && (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-yellow-700">
                          {batterHealth.warnings.map((warning: string, i: number) => (
                            <li key={i}>• {warning}</li>
                          ))}
                        </ul>
                      </div>
