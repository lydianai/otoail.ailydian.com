    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden animate-in slide-in-from-bottom-4 duration-500 max-h-[95vh] overflow-y-auto">
        ...
        <div className="h-2 bg-gray-100 relative overflow-hidden">
          <div
            className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-600 to-purple-600 transition-all duration-500 ease-out"
        ...
        <div className="p-4 sm:p-8">
          ...
          <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="p-2 sm:p-3 bg-gradient-to-br from-blue-100 to-purple-100 rounded-xl sm:rounded-2xl flex-shrink-0">
              {step.icon || <Heart className="h-6 w-6 sm:h-8 sm:w-8 text-blue-600" />}
            </div>
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-6 sm:mb-8">
            <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 bg-blue-50 text-blue-700 rounded-full text-xs sm:text-sm font-semibold">
              <Shield className="h-3 w-3 sm:h-4 sm:w-4" />
              <span>HIPAA Compliant</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 bg-purple-50 text-purple-700 rounded-full text-xs sm:text-sm font-semibold">
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <Button
                onClick={handleNext}
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg text-xs sm:text-sm px-3 sm:px-4"
              >
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-4 sm:px-8 py-3 sm:py-4 border-t border-gray-200">
          <div className="flex items-center justify-between text-xs text-gray-600 gap-2">
            ...
            <span className="font-mono whitespace-nowrap">{Math.round(progress)}% completed</span>
          </div>
        </div>
      </div>
    </div>
