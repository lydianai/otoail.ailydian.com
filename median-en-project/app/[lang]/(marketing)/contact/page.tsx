          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border-2 border-blue-200 text-center">
              ...
              <div className="space-y-1">
                <p className="text-gray-600 font-medium text-sm">Contact us via email</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 border-2 border-purple-200 text-center">
              ...
              <div className="space-y-1">
                <p className="text-purple-600 font-bold">median@ailydian.com</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border-2 border-blue-200">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-gray-900 mb-1">United States Office</h3>
                      <p className="text-blue-600 font-bold">Jacksonville, Florida</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-medium">
                          1431 Riverplace Blvd, Suite 200<br />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-medium">Mon-Fri: 8:00 AM - 6:00 PM EST</p>
                ...
                <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 border-2 border-red-200">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-red-600 font-bold">Alanya, Antalya</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-medium">
                          Saray Mahallesi, Atatürk Caddesi No: 45<br />
                          Alanya, Antalya 07400<br />
                          Turkey
                        </p>
                      </div>
                    </div>
