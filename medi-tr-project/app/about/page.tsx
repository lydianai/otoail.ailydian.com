...
export default function AboutPage() {
  const teamMembers = [
    ...
    },
    {
      ...
      role: 'CTO & Co-Founder',
      bio: 'Ex-Google Health engineer. Led modern healthcare integration teams at 3 major health systems.',
      icon: Zap,
    },
    {
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-lg border-2 border-blue-200 mb-8">
            ...
            <span className="text-sm font-bold text-gray-900">Next-Generation Healthcare Technology</span>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 font-semibold">Primary: +1 (800) 555-0123</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 font-semibold">Primary: +90 (212) 555-0123</p>
                </div>
              </div>
            </div>
          </div>
