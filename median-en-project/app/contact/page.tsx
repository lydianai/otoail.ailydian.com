          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border-2 border-blue-200 text-center">
              ...
              <div className="space-y-1">
                <p className="text-gray-700 font-semibold">Please use the</p>
                <p className="text-gray-700 font-semibold">contact form below</p>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-semibold">Please use the contact form</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 font-medium">tr-satis@lydianmedi.com</p>
                      </div>
                    </div>
