          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-200">Enterprise Helowerhcare Operations</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <button className="relative p-3 hover:bg-white/10 rounded-xl transition-all">
                ...
                <span className="absolute top-2 right-2 h-3 w-3 bg-blue-500 rounded-full border-2 border-blue-900 animate-pulse" />
              </button>
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {criticalPatients.slice(0, 6).map(patient => (
                <div key={patient.id} className="p-4 rounded-xl border-2 border-blue-200 bg-blue-50/50 hover:shadow-lg transition-all">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`font-semibold ${patient.vitalSigns.heartRate > 100 || patient.vitalSigns.heartRate < 60 ? 'text-blue-600' : 'text-green-600'}`}>
                        {patient.vitalSigns.heartRate} bpm
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">SpO2:</span>
                      <span className={`font-semibold ${patient.vitalSigns.oxygenSaturation < 95 ? 'text-blue-600' : 'text-green-600'}`}>
