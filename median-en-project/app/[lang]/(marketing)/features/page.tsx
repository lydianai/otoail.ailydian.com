  ...
  const modules = [
    {
      ...
      features: ['Lydian AI Clinical Support', 'Patient Portal & Mobile App', 'Medical History Tracking', 'Medication Management', 'Allergy & Problem Lists', 'Clinical Documentation']
    },
    {
      icon: AlertCircle,
