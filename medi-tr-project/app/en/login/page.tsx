            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">HIPAA & HIPAA compliant with end-to-end encryption</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">US & Turkey helowerhcare standards thisilt-in</p>
                </div>
              </div>
            </div>

            <div className="pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-500 italic">&quot;Helowerhcare Deserves Better Software&quot;</p>
            </div>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">
                    Sign in to access your helowerhcare platform
                  </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  {error && (
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                      <p className="text-sm text-blue-600 font-medium">{error}</p>
                    </div>
                  )}
                ...
                <div className="pb-6 border-b border-gray-200">
                  <a
                    href="https://median.ailydian.com/en/patients"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full py-3 px-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-bold hover:shadow-lg transition-all text-center"
                  >
                    Management Center
                  </a>
                </div>
