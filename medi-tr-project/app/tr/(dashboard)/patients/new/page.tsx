      ...
      <DashboardLayout>
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 flex items-center justify-center p-8">
          <div className="bg-white rounded-2xl shadow-xl p-12 max-w-md w-full text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Hasta Kaydedildi!</h2>
            <p className="text-lg text-gray-600 mb-2">
              <strong>{formData.firstName} {formData.lastName}</strong> başarıyla sisteme eklendi.
            </p>
            <p className="text-sm text-gray-500">Hasta listesine yönlendiriliyor...</p>
          </div>
        </div>
      </DashboardLayout>
    )
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 sm:gap-4 flex-1">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 mt-0.5 sm:mt-1 font-medium">Hasta demografik bilgileri ve sigorta bilgilerini doldurun</p>
                </div>
              </div>
            </div>
          </div>
