...
export default function HelpPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes! Median integrates with all major EHR systems including Epic, Cerner, Meditech, Allscripts, and athenahealth. We support HL7 v2.x, FHIR R4/R5, and direct API integrations. Our integration team will assess your current system and recommend the best approach.',
    },
    {
      category: 'Features',
  ...
  const popularTopics = [
    ...
    { title: 'Integrating with Epic EHR', views: '9.7K', category: 'Integrations' },
