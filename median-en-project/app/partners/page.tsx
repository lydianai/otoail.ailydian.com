  ...
  const ehrIntegrations = [
    {
      ...
      status: 'Certified',
      description: 'Seamless bi-directional integration with Epic EHR for patient data sync',
    ...
    },
    {
      ...
      category: 'Enterprise EHR',
      status: 'Certified',
      description: 'Native integration with Cerner Millennium and Oracle Health platforms',
    ...
    },
    {
      ...
      status: 'Certified',
      description: 'Comprehensive integration with Meditech Expanse and Magic platforms',
    ...
    },
    {
      ...
      status: 'Certified',
      description: 'Full integration suite for Allscripts Sunrise and TouchWorks',
